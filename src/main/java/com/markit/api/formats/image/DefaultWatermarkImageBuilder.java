...
public final class DefaultWatermarkImageBuilder
        extends DefaultVisualWatermarkBuilder<ImageWatermarkContentStep, WatermarkImageBuilder>
        implements ImageWatermarkContentStep, WatermarkImageBuilder {

    public DefaultWatermarkImageBuilder(byte[] fileBytes) {
        super(createWatermarkProcessor(fileBytes));
    }

    public DefaultWatermarkImageBuilder(File file) {
